...
const en = {
  ...
  'nav.gallery': 'Gallery',
  'gallery.eyebrow': 'Every photo',
  'gallery.title': 'The whole job, every job.',
  'gallery.sub': 'Every photo we have, grouped by job. No stock photos, no filters.',
  'gallery.count': '{n} photos',
  'gallery.jump': 'Jump to a job',
  'gallery.detailsTitle': 'Miters, downspouts, guards, and close-ups.',
  'gallery.moreEyebrow': 'More jobs',
  'gallery.moreTitle': 'Other houses we did.',
  'gallery.link': 'See every photo',
  'intro.label': 'Intro',
  'intro.cap1Eyebrow': 'Every storm in Florida',
  'intro.cap1Title': 'Straight down the walls.',
  'intro.cap1Body': 'No gutters means every downpour lands on your foundation.',
  'intro.cap2Eyebrow': 'Seamless gutters · made on site',
  'intro.cap2Body': 'One seamless piece, run at your house, carries it all away.',
  'intro.scroll': 'Scroll',
...
const es: Record<UiKey, string> = {
  ...
  'nav.gallery': 'Galería',
  'gallery.eyebrow': 'Todas las fotos',
  'gallery.title': 'Todo el trabajo, en cada trabajo.',
  'gallery.sub': 'Todas las fotos que tenemos, agrupadas por trabajo. Sin fotos de archivo, sin filtros.',
  'gallery.count': '{n} fotos',
  'gallery.jump': 'Ir a un trabajo',
  'gallery.detailsTitle': 'Esquinas, bajantes, protectores y acercamientos.',
  'gallery.moreEyebrow': 'Más trabajos',
  'gallery.moreTitle': 'Otras casas que hicimos.',
  'gallery.link': 'Ver todas las fotos',
  'intro.label': 'Introducción',
  'intro.cap1Eyebrow': 'Cada tormenta en Florida',
  'intro.cap1Title': 'Directo por las paredes.',
  'intro.cap1Body': 'Sin canaletas, cada aguacero cae sobre su cimiento.',
  'intro.cap2Eyebrow': 'Canaletas sin costura · hechas en el sitio',
  'intro.cap2Body': 'Una sola pieza sin costura, hecha en su casa, se lo lleva todo.',
  'intro.scroll': 'Deslice',
